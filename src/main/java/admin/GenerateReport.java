...
public class GenerateReport extends JFrame {
	...
	public GenerateReport() {
		...
		start.setBounds(75, 119, 86, 20);
		contentPane.add(start);
		start.setColumns(10);
		
		end = new JTextField();
		end.setBounds(233, 119, 86, 20);
		contentPane.add(end);
		end.setColumns(10);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					java.util.Date utilDate = new SimpleDateFormat("yyyy-MM-dd").parse(day1);
					Date sqlDate = new Date(utilDate.getTime());
					String day2 = end.getText();
					java.util.Date utilDate2 = new SimpleDateFormat("yyyy-MM-dd").parse(day1);
